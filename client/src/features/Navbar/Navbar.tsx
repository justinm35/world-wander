        ...
        <div className="w-full px-10 flex flex-wrap items-center justify-between">
            ...
            <div className=" w-auto">
                <ul className=" flex md:text-sm md:font-medium items-center">
                    ...
                    {localStorage.getItem('Bearer') &&
                    <li><NavLink to="/"><button className=" transition py-2 mr-5 font-roboto px-5 text-purple-700 border-2 rounded-lg text-lg border-purple-700 hover:bg-purple-700 hover:text-white">Discover Others</button></NavLink></li>}
                    {localStorage.getItem('Bearer') &&
                    <li>
